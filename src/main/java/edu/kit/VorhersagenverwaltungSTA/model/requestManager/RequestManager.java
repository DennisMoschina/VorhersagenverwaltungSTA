...
import edu.kit.VorhersagenverwaltungSTA.model.requestManager.encoder.selection.GenericSelectionEncoder;
...
public class RequestManager {
    ...
    private final Map<Class<?>, ObjectContainer<?>> containers = new HashMap<>();
